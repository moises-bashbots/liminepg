...
public class FieldCNAB 
{
	...
	public FieldCNAB(int ordinal, int begin, int end, int size, String name, String content, String charset, int decimais)
	{
//		System.out.println(this.name+ " Content: '"+content+"'");
	...
	public FieldCNAB(int ordinal, int begin, int end, int size, String name, String content, String charset)
	{
//		System.out.println(this.name+ " Content: '"+content+"'");
		if(content==null)
		{
	...
	public FieldCNAB(int ordinal, int begin, int end, String name, int size, String content, String charset)
	{
//		System.out.println(this.name+ " Content: '"+content+"'");
		if(content==null)
		{
...
//		System.out.println("After:  '" + lineReplaced + "'");
	...
	public String replaceV(String line, RegistroCNAB registro)
	{
		line = Utils.normalizeUri(line);
...
//		System.out.println("LineAfterSize: " + line.length());
	...
	{
		FieldCNAB field = new FieldCNAB(1,1,1,"Identificacao de registro",1,"1","N");
		FieldCNAB field2 = new FieldCNAB(2,2,6,"Agencia de debito",8,"1189","N");
		FieldCNAB field3 = new FieldCNAB(2,2,6,"Agencia de debito",15,"COBRANCA","A");
