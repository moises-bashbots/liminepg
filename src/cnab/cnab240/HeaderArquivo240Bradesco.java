...
public class HeaderArquivo240Bradesco extends RegistroCNAB
{
	...
	private FieldCNAB layoutDoArquivo=new FieldCNAB(20,164,166,3,"Numero Versao Layout do Arquivo",BuilderPaymentsMultibanco.getVersaoLayout().get("237"),"N");
	private FieldCNAB densidadeArquivo=new FieldCNAB(21,167,171,5,"Densidade de Gravacao do Arquivo","1600","N");
	...
	public HeaderArquivo240Bradesco()
	{
		super();
		this.setSize(240);
	...
	public HeaderArquivo240Bradesco(Pagador pagador, int iArquivo)
	{
		super();
		this.setSize(240);
		this.setTipo("HeaderArquivo240");
