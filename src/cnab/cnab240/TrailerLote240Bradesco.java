...
public class TrailerLote240Bradesco extends RegistroCNAB 
{
	...
	public TrailerLote240Bradesco(Pagador pagador, ArrayList<DetalhePagamentoAB240> detalhes, int iLote)
	{
		super();
		this.setSize(240);
		this.setTipo("TrailerLote240");
		...
		{
				valorTotalInteiro+=detalhe.getDetalheABradesco().getPagamento().getValorInteiro();
				quantidadeTotal+=Utils.doubleFromCNABValue(detalhe.getDetalheABradesco().getQuantidadeMoeda());
		}
		this.getValor().setContent(Long.toString(valorTotalInteiro));
//		Utils.doubleToCNABValue(this.getValor(), valorTotal);
		Utils.doubleToCNABValue(this.getQuantidadeMoedas(), quantidadeTotal);
		this.buildTrailer();
	}
