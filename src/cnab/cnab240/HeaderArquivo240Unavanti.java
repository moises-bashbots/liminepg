...
public class HeaderArquivo240Unavanti extends RegistroCNAB
{
...
//	private FieldCNAB layoutDoArquivo=new FieldCNAB(5,15,17,3,"Numero Versao Layout do Arquivo",BuilderCNAB240MultipagMultibanco.getVersaoLayout().get("460"),"N");
	private FieldCNAB layoutDoArquivo=new FieldCNAB(5,15,17,3,"Numero Versao Layout do Arquivo",BuilderPaymentsMultibanco.getVersaoLayout().get("460"),"N");
	...
	public HeaderArquivo240Unavanti()
	{
		super();
		this.setSize(240);
	...
	public HeaderArquivo240Unavanti(Pagador pagador, int iArquivo)
	{
		super();
		this.setSize(240);
		this.setTipo("HeaderArquivo240");
		...
		this.getDigitoVerificadorAgenciaConta().setContent(pagador.getDadosBancarios().getDigitoConta());
	...
	public static void setSdf(SimpleDateFormat sdf) {
		HeaderArquivo240Unavanti.sdf = sdf;
	}
	...
	public static void setSdft(SimpleDateFormat sdft) {
		HeaderArquivo240Unavanti.sdft = sdft;
	}
