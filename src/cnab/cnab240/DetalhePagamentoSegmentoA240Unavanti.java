...
public class DetalhePagamentoSegmentoA240Unavanti extends RegistroCNAB
{
...
//	private FieldCNAB codigoMovimento=new FieldCNAB(7,16,17,2,"Codigo da Instrucao para Movimento","","N");
	...
	private FieldCNAB informacao2=new FieldCNAB(24,178,203,26,"Outras informacoes para identificacao de Deposito Judicial e Pagamento Salarios de servidores pelo SIAPE","","A");
	private FieldCNAB documentoFavorecido = new FieldCNAB(25,204,217,14,"documentoFavorecido","","N");
	private FieldCNAB codigoFinalidadeDOC=new FieldCNAB(26,218,219,2,"Complemento Tipo Servico","","A");
	private FieldCNAB codigoFinalidadeTED=new FieldCNAB(27,220,224,5,"Codigo Finalidade da TED","","A");
	private FieldCNAB codigoFinalidadeComplementar=new FieldCNAB(28,225,226,2,"Complemento Finalidade de Pagamento","","A");
	private FieldCNAB cnab=new FieldCNAB(29,227,229,3,"Uso exclusivo FEBRABAN/CNAB","","A");
	private FieldCNAB aviso=new FieldCNAB(30,230,230,1,"Aviso ao Favorecido","","N");
	private FieldCNAB ocorrencias=new FieldCNAB(31,231,240,10,"Codigos de ocorrencias para retorno","","A");
	
	private PagamentoFornecedor pagamento=new PagamentoFornecedor();
	
	
	public DetalhePagamentoSegmentoA240Unavanti()
	{
		super();
		this.setSize(240);	
	...
	public DetalhePagamentoSegmentoA240Unavanti(PagamentoFornecedor pagamento, int iLote)
	{
...
//		Utils.doubleToCNABValue(this.valorReal, pagamento.getValorInteiro()/100.0);
		...
		this.getDocumentoFavorecido().setContent(pagamento.getFavorecido().getNumeroInscricao());
	...
	public void buildSegmentoA()
	{
		...
		GrupoRegistrosCNAB documentoFavorecido = new GrupoRegistrosCNAB();
		...
		documentoFavorecido.getFieldsCNAB().put("documentoFavorecido", this.documentoFavorecido);
		...
		segmentosDetalhe.put("documentoFavorecido", documentoFavorecido);
	...
	public static void setSdf(SimpleDateFormat sdf) {
		DetalhePagamentoSegmentoA240Unavanti.sdf = sdf;
	}
	...
	public FieldCNAB getDocumentoFavorecido() {
		return documentoFavorecido;
	}

	public void setDocumentoFavorecido(FieldCNAB documentoFavorecido) {
