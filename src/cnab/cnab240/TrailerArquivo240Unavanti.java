...
public class TrailerArquivo240Unavanti extends RegistroTrailerDeArquivo 
{
	...
	public TrailerArquivo240Unavanti()
	{
		super();
		this.setSize(240);
	...
	public TrailerArquivo240Unavanti(Pagador pagador, ArrayList<Lote240> lotes)
	{
		super();
		this.setSize(240);
		this.setTipo("TrailerArquivo240");
