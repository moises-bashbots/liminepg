...
public class TrailerLote240Itau extends RegistroCNAB 
{
	...
	public TrailerLote240Itau(Pagador pagador, ArrayList<DetalhePagamentoAB240> detalhes, int iLote)
	{
		super();
		this.setSize(240);
		this.setTipo("TrailerLote240");
		...
		{
			valorTotalInteiro+=detalhe.getDetalheAItau().getPagamento().getValorInteiro();
			quantidadeTotal+=Utils.doubleFromCNABValue(detalhe.getDetalheAItau().getQuantidadeMoeda());
		}
