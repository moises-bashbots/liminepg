...
public class DetalhePagamentoSegmentoA240Santander extends RegistroCNAB
{
	...
	private FieldCNAB tipoMovimento=new FieldCNAB(6,15,15,1,"Tipo de Movimento","","N");
	private FieldCNAB codigoMovimento=new FieldCNAB(7,16,17,2,"Codigo da Instrucao para Movimento","","N");
	
	private FieldCNAB camara=new FieldCNAB(8,18,20,3,"Codigo da Camara Centralizadora","","N");
	private FieldCNAB bancoFavorecido=new FieldCNAB(9,21,23,3,"Codigo do Banco do Favorecido","","N");
	private FieldCNAB agenciaFavorecido=new FieldCNAB(10,24,28,5,"Agencia do Favorecido","","N");
	private FieldCNAB digitoVerificadorAgenciaFavorecido=new FieldCNAB(11,29,29,1,"Digito Verificador da Agencia do Favorecido","","A");
	private FieldCNAB contaFavorecido=new FieldCNAB(12,30,41,12,"Numero da Conta Corrente do Favorecido","","N");
	private FieldCNAB digitoVerificadorContaFavorecido=new FieldCNAB(13,42,42,1,"Digito Verificador da Conta Corrente Favorecido","","A");
	private FieldCNAB digitoVerificadorAgenciaContaFavorecido=new FieldCNAB(14,43,43,1,"Digito Verificador Agencia/Conta Favorecido","","A");
	private FieldCNAB nomeFavorecido=new FieldCNAB(15,44,73,30,"Nome do Favorecido","","A");
	
	private FieldCNAB seuNumero=new FieldCNAB(16,74,93,20,"Numero Documento Atribuido pela Empresa","","A");
	private FieldCNAB dataPagamento=new FieldCNAB(17,94,101,8,"Data do Pagamento","","N");
	private FieldCNAB tipoMoeda=new FieldCNAB(18,102,104,3,"Tipo da Moeda","","A");
	...
	public DetalhePagamentoSegmentoA240Santander()
	{
		super();
		this.setSize(240);	
	...
	public DetalhePagamentoSegmentoA240Santander(PagamentoFornecedor pagamento, int iLote)
	{
		...
		this.getTipoMovimento().setContent("0");
//		if(BuilderCNAB240MultipagGeneric.isApprovedFiles())
//		{
//			this.getCodigoMovimento().setContent("00");
//		}
//		else
//		{
//			this.getCodigoMovimento().setContent("09");
//		}
		if(pagamento.getPagador().getDadosBancarios().isAprovado() && !BuilderPaymentsMultibanco.readCSV)
		{
			this.getCodigoMovimento().setContent("00");
		}
		else
		...
		this.getContaFavorecido().setContent(pagamento.getFavorecido().getDadosBancarios().getNumeroConta());
...
//		Utils.doubleToCNABValue(this.valorReal, pagamento.getValorInteiro()/100.0);
	...
	public void buildSegmentoA()
	{
		...
		servico.getFieldsCNAB().put("codigoMovimento", this.codigoMovimento);
	...
	public FieldCNAB getCodigoMovimento() {
		return codigoMovimento;
	}

	public void setCodigoMovimento(FieldCNAB codigoMovimento) {
	...
	public static void setSdf(SimpleDateFormat sdf) {
		DetalhePagamentoSegmentoA240Santander.sdf = sdf;
	}
