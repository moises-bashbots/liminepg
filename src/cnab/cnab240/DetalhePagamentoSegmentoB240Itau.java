...
public class DetalhePagamentoSegmentoB240Itau extends RegistroCNAB
{
	...
	public DetalhePagamentoSegmentoB240Itau()
	{
		super();
		this.setSize(240);
	...
	public DetalhePagamentoSegmentoB240Itau(PagamentoFornecedor pagamento, int iLote)
	{
		super();
		this.setSize(240);
		this.setTipo("SegmentoB");
	...
	public static void setSdf(SimpleDateFormat sdf) {
		DetalhePagamentoSegmentoB240Itau.sdf = sdf;
	}
