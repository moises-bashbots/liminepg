...
public class HeaderLote240Unavanti extends RegistroCNAB
{
	...
	public HeaderLote240Unavanti(Pagador pagador, int iLote, String formaLancamento)
	{
		super();
		this.setSize(240);
		this.setTipo("HeaderLote240");
